    ...
    <section id="about" className="py-4 rounded-t-xl bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        <article className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-10 space-y-6">
          <h2 className="text-3xl font-title font-semibold">Who I Am and Why You Should Hire Me</h2>
          <p>
            ...
            rest assured, you won’t succeed). If you’re a recruiter, after reviewing hundreds of CVs, this one will probably seem more original than most, and you’re wondering who I am and
